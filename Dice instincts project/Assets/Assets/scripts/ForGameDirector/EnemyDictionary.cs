...
public class EnemyDictionary : FrameworkDictionary
{
    ...
    public override void InitList()
    {
        ...
        AddToList(0, "Mondo", 15,4, new List<FuncArgs>() { new FuncArgs(cardGameManager.GainBlock,cardGameManager.EffectOnSelf, 8, EffectTiming.Immidiate), new FuncArgs(cardGameManager.DealDamage, cardGameManager.EffectOnPlayer, 8, EffectTiming.Immidiate)});
    }
