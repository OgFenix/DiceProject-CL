...
public partial class CardsDictionary : FrameworkDictionary
{
    ...
    public override void InitList()
    {
        ...
        AddToList(4, "Poison" , 2, "Apply 8 " + Status.poison + " to an enemy", Classes.Warrior, new int[] {41,53}, new List<FuncArgs>() { new FuncArgs(cardGameManager.ApplyStatus, cardGameManager.EffectOnEnemyTargeted, 8, EffectTiming.Immidiate, Status.poison) }, false);
